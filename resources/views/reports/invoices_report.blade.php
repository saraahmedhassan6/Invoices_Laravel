    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{__('reports.reports')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    {{__('reports.report_invoice')}} </span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="rdio" type="radio" value="1" id="type_div"> <span>
                                {{__('reports.search_by_invoice_type')}}</span></label>
                    </div>


                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox"><input name="rdio" value="2" type="radio"><span>
                          {{__('reports.search_by_invoice_number')}}  </span></label>
                    </div><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">{{__('reports.select_invoice_type')}}</p><select class="form-control select2" name="type"
                                required>
                                <option value="{{ $type ?? __('reports.select_invoice_type')}}" selected>
                                    {{ $type ?? __('reports.select_invoice_type')}}
                                </option>

                                <option value="مدفوعة">{{__('invoices.paid_invoices')}}</option>
                                <option value="غير مدفوعة">{{__('invoices.unpaid_invoices')}}</option>
                                <option value="مدفوعة جزئيا">{{__('invoices.partially_paid_invoices')}}</option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                            <p class="mg-b-10">{{__('reports.search_by_invoice_number')}}</p>
